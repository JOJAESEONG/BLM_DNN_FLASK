...
def eu_a(ph,na,ca,mg,al,doc,dc):
    ...
    result1=kr_test_reshape_NN.item()
...
def asia_a(ph,na,ca,mg,al,doc,dc):
    ...
    model_a_cu.load_state_dict(torch.load('full-para_training_model.pth'))
    ...
    output_a_asia_a= float(output_a_cu_asia)*3.22
    x_a_asia=float(Annual_dissolved_Cu)/(output_a_cu_asia*3.22)
...
def eu_b(ph,na,ca,mg,doc,dc):
    ...
    result_b_eu=kr_test_reshape_NN.item()
...
def asia_b(ph,na,ca,mg,doc,dc):
    ...
    output_cu_asia_b_b=float(result_b_asia)*3.22
    x_cu_asia_b=float(Individual_dissolved_Cu)/(result_b_asia)*3.22
...
def eu_c(ph,ec,doc,dc):
    ...
    output_c_eu_cu=float(kr_test_reshape_NN.item())
...
def asia_c(ph,ec,doc,dc):
    ...
    model_C_Cu.load_state_dict(torch.load('cond_training_model_correct_MLR_v1.pth'))
    ...
    output_c_asia_cu=float(kr_test_reshape_NN.item())*3.22
